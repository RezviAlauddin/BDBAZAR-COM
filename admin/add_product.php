   ...
   <html>
    ...
    <body>
       <?php
            ...
            if(isset($_POST['submit'])){
                ...
                if($conn){
                    ...
                    if($result_first>0){
                        ...
                        $product_amount = $product_amount + $row['product_quantity'];
                        $mysecond_qur = "UPDATE product_info SET product_quantity = '$product_amount' WHERE product_code = '$product_code'";
        ...
        ?>
        <div class="addproductrow1_holder">
